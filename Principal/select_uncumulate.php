...
?>
  ...
  <div class="wrapper">
    ...
    <h2>Class</h2>
    <form action="select_uncumulate.php" method="post" style="min-height: 250px;">
      <div class="input-box">
      ...
      <div class="text">
        <h3><a href="principal.php" style="text-decoration: none; font-size:15px; font-weight: 500px;">Return</a></h3>
      </div>
      <div class="message">
        <?php
        include 'connect.php';
                   ...
                   //  $_SESSION['year'] = $a_y;
                     ...
                     animation:button .3s linear;text-align: center;">
                                     <?php echo "SELECTED CLASS: $class_name ";
                                         header("refresh:2;url=uncumulate.php"); ?>
                                 </div> <?php
                    }
