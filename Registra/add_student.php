...
<body>
    ...
    font-weight: bold; color: #1D5B79;">Add Student</Label>
        ...
        oci_execute($sql);
        $sql = oci_parse($conn, "select * from SGEN_ID ");
        oci_execute($sql);
        if ($r = oci_fetch_array($sql)) {
            $id = $r['ID'];
        }
        if ($id >= 0 &&  $id <= 9) {
            $stuid = '000' . $id . $currentDate;
        } else if ($id >= 10 && $id <= 99) {
            $stuid = '00' . $id . $currentDate;
        } else if ($id >= 100 && $id <= 999) {
            $stuid = '0' . $id . $currentDate;
        } else if ($id >= 1000) {
            $stuid = $id . $currentDate;
        }
        $sql = oci_parse($conn, "delete from sgen_id");
        oci_execute($sql);
        ?>
        <div style="display:flex; margin-top:20px;">
            <Label style="font-size: 25px; font-family: righteous;
         font-weight: bold; ">New Student ID : <?php echo $stuid ?></Label>
        </div>
        ...
        <div class="input-container" style="display: flex;">
            ...
            <div class="input-field" style="margin-right: 10px; ">
                ...
                <label for="subjectCode" style="font-weight: 900;">(Required) </label>
                <input type="text" placeholder="Enter Lastname" title="Only Letters" pattern="[A-z0-9 ]+" name="stu_last" required>
            </div>
        ...
        <div class="input-container" style="display: flex;">
            <div class="input-field" style="margin-right: 10px; ">
                ...
                <select name="stu_tribe" required>
                    ...
                    <option>Jola</option>
                    <option>Serer</option>
                    <option>Serahuli</option>
                    <option>Aku</option>
                    <option>Manjago</option>
                    <option>Bambara</option>
                    <option>Other</option>
                </select>
                <label for="subjectCode">Religion</label>
                <select name="stu_religion" required>
        ...
        <div class="input-container" style="display: flex;">
            ...
            <div class="input-field" style="margin-right: 10px; ">
                ...
                <label for="subjectCode" style="font-weight: 900;"> </label>
                <input type="file" name="pg_photo">
            </div>
        ...
        <div class="input-container" style="display: flex;">
            <div class="input-field" style="margin-right: 10px; ">
                <label for="subjectCode">Father's Name</label>
                <label for="subjectCode" style="font-weight: 900;">(Required) </label>
                <input type="text" placeholder="Enter Father's Name" title="Only Letters" name="stu_father" pattern="[A-z ]+" required>
            </div>
            <div class="input-field" style="margin-right: 10px; ">
                <label for="subjectCode">Father's Occupation</label>
                <input type="text" placeholder="Enter Father's Occupation" title="Only Letters" name="father_occup" pattern="[A-z ]+" style="width:250px;">
            </div>
            <div class="input-field" style="margin-right: 10px; ">
                <label for="subjectCode">Mother's Name</label>
                <label for="subjectCode" style="font-weight: 900;">(Required) </label>
                <input type="text" placeholder="Enter Mother's Name" title="Only Letters" name="stu_mother" pattern="[A-z ]+">
            </div>
            <div class="input-field" style="margin-right: 10px; ">
                <label for="subjectCode">Mother's Occupation</label>
                <input type="text" placeholder="Enter Father's Occupation" title="Only Letters" name="mother_occup" pattern="[A-z ]+" style="width:250px;">
            </div>
        </div>
        ...
        <div class="input-container" style="display: flex;">
            ...
            <div class="input-field" style="margin-right: 10px;">
                <label>Enrolling Academic Year</label>
                <label for="subjectCode" style="font-weight: 900;">(Required) </label>
                <select required name="stu_acadyear">
            ...
            if (isset($_POST['stu_gender'])) {
                if (isset($_POST['stu_nation'])) {
                    if (isset($_POST['stu_tribe'])) {
                        if (isset($_POST['stu_religion'])) {
                            if (isset($_POST['pg_relation'])) {
                                if (isset($_POST['stu_acadyear'])) {


                                    //STUDENT PERSONAL 
                                    $first = trim(strtoupper($_POST['stu_first']));
                                    $middle = trim(strtoupper($_POST['stu_middle']));
                                    $last = trim(strtoupper($_POST['stu_last']));
                                    $dob = $_POST['stu_dob'];
                                    $gender = $_POST['stu_gender'];
                                    $nation = strtoupper($_POST['stu_nation']);
                                    $tribe = strtoupper($_POST['stu_tribe']);
                                    $religion = strtoupper($_POST['stu_religion']);
                                    if ($middle != '') {
                                    ...
                                    $stu_father = strtoupper($_POST['stu_father']);
                                    $stu_mother = strtoupper($_POST['stu_mother']);
                                    ...
                                    //STUDENT ACADEMIC 
                                    $stu_prev = strtoupper($_POST['stu_prev']);
                                    $stu_class = $_POST['stu_class'];
                                    $stu_score = $_POST['stu_score'];
                                    $stud_acad = $_POST['stu_acadyear'];
                                    //STUDENT DOCUMENT
                                    ...
                                    if (oci_fetch_all($sql, $a) == 0) {
                                        ...
                                        $sql = oci_parse($conn, "INSERT INTO STUDENT (S_ID,STUD_ID,NAME,STATUS,CREATE_DT,STDNUMBER) VALUES ('$sid','$stuid','$name','REGISTERED',SYSDATE,'$stuid')");
                                        ...
                                        if (oci_fetch_all($sql, $a) == 0)
                                            $sql = oci_parse($conn, "INSERT INTO STUDENT_PERSONAL (STUD_ID,S_ID,FIRSTNAME,MIDDLENAME,LASTNAME,DOB,GENDER,NATION,TRIBE,RELIGION) VALUES ('$stuid',$sid,'$first','$middle','$last','$dob','$gender','$nation','$tribe','$religion')");
                                        oci_execute($sql, OCI_NO_AUTO_COMMIT);
                                        oci_commit($conn);
                                        ...
                                        if (oci_fetch_all($sql, $a) == 0) {
                                            ...
                                            if (oci_fetch_all($sql, $a) == 0) {
                                                if (!empty($pg_photo) && file_exists($pg_photo) && (isjpeg_png($pg_photo))) {
                                                    $sql = oci_parse($conn, "INSERT INTO STUDENT_AUTHOURITY (STUD_ID,S_ID,FIRSTNAME,MIDDLENAME,LASTNAME,ADDRESS,PHONE,EMAIL,OCCUPATION,RELATION,FATHER,MOTHER,FATHER_OCCUP,MOTHER_OCCUP) VALUES ('$stuid',$sid,'$pg_first','$pg_middle','$pg_last','$pg_add',$pg_phone,'$pg_email','$pg_occu','$pg_relation','$stu_father','$stu_mother','$father_occup','$mother_occup')");
                                                    oci_execute($sql, OCI_NO_AUTO_COMMIT);
                                                    oci_commit($conn);
                                                    ...
                                                    if (oci_fetch_all($sql, $a) == 0) {
                                                        ...
                                                        if (oci_fetch_all($sql, $a) == 0) {
                                                            ...
                                                            $sql = oci_parse($conn, "select * from sub_class where class_name='$stu_class'");
                                                            oci_execute($sql);
                                                            ...
                                                            $sql = oci_parse($conn, "INSERT INTO STUDENT_ACADEMIC (STUD_ID,S_ID,CLASS,PREV_SCHOOL,SCORE,SUB_CODE,ACADEMIC_YEAR) VALUES ('$stuid','$sid','$stuclass','$stu_prev','$stu_score','$subclass','$stud_acad')");
                                                            oci_execute($sql, OCI_NO_AUTO_COMMIT);
                                                            oci_commit($conn);
                                                            ...
                                                            if (oci_fetch_all($sql, $a) == 0) {
                                                                ...
                                                                // Assuming $stu_birth, $stu_natid, and $stu_pass are the paths to files

                                                                // Check if the paths are not empty and the files exist before proceeding
                                                                if (
                                                                    (!empty($stu_birth) && file_exists($stu_birth) &&
                                                                        isjpeg_png($stu_birth)) &&

                                                                    (!empty($stu_natid) && file_exists($stu_natid) && isjpeg_png($stu_natid)) &&

                                                                    (!empty($stu_pass) && file_exists($stu_pass) && isjpeg_png($stu_natid))
                                                                ) {
        ...
        ?><div style="font-size:15px;
															...
															Swal.fire({
																...
																timer: 1500
                                                                            ...
                                                                            ?></div><?php
                                                                                ...
                                                                                $ACADEMIC = oci_parse($conn, "SELECT * FROM STUDENT_ACADEMIC WHERE S_ID=$sid and stud_id= '$stuid'");
                                                                                oci_execute($ACADEMIC);
                                                                                $DOCUMENT = oci_parse($conn, "INSERT INTO STUDENT_DOCUMENT (STUD_ID,S_ID) VALUES ('$stuid',$sid)");
                                                                                oci_execute($DOCUMENT, OCI_NO_AUTO_COMMIT);
                                                                                oci_commit($conn);
                                                                                $DOCUMENT = oci_parse($conn, "SELECT * FROM STUDENT_DOCUMENT WHERE S_ID=$sid and stud_id= '$stuid'");
                                                                                oci_execute($DOCUMENT);

                                                                                if ((oci_fetch_all($student, $a) > 0) && (oci_fetch_all($personal, $a) > 0) && (oci_fetch_all($contact, $a) > 0) && (oci_fetch_all($AUTHOURITY, $a) > 0) && (oci_fetch_all($MEDICAL, $a) > 0) && (oci_fetch_all($ACADEMIC, $a) > 0) && (oci_fetch_all($DOCUMENT, $a) > 0)) {
                                                                                    $sql = oci_parse($conn, "INSERT INTO SCHOOL_USERS (S_ID,FIRSTNAME,MIDDLENAME,LASTNAME,DOB,GENDER,ADDRESS,MOBILE,WORK,EMAIL,USERNAME,PASSWORD,RIGHTS,CREATE_DT) VALUES ($sid','$first','$middle','$last','$dob','$gender','$stu_add','$stu_phone','$stu_phone','$stu_email','$stuid','ChangePassword','STUDENT',SYSDATE)");
                                                                                    oci_execute($sql);
                                                                                    ?><div style="font-size:15px;
                                                                            color: green;
                                                                            position: relative;
                ...
                ?><div style="font-size:15px;
															...
															Swal.fire({
																position: "center",
																icon: "error",
																title: "ACADEMIC INFORMATION ALREADY SAVED",
																showConfirmButton: false,
																timer: 1500
															  });
															</script>';
															...
															Swal.fire({
																position: "center",
																icon: "error",
																title: "MEDICAL INFORMATION ALREADY SAVED",
																showConfirmButton: false,
																timer: 1500
															  });
															</script>';
                ...
                ?><div style="font-size:15px;
															...
															Swal.fire({
																position: "center",
																icon: "error",
																title: "DOCUMENTATION ALREADY UPLOADED",
																showConfirmButton: false,
																timer: 1500
															  });
															</script>';
            ...
            ?><div style="font-size:15px;
                                                    ...
                                                    <?php echo '<script>
															Swal.fire({
																position: "center",
																icon: "error",
																title: "PARENT/GUARDIAN INFORMATION ALREADY SAVED",
																showConfirmButton: false,
																timer: 1500
															  });
															</script>';
                                                ...
                                                <?php echo '<script>
															Swal.fire({
																position: "center",
																icon: "error",
																title: "CONTACT INFORMATION ALREADY SAVED",
																showConfirmButton: false,
																timer: 1500
															  });
															</script>';
                                            ...
                                            <?php echo '<script>
															Swal.fire({
																position: "center",
																icon: "error",
																title: "PERSONAL INFORMATION ALREADY SAVED",
																showConfirmButton: false,
																timer: 1500
															  });
															</script>';
...
function ispdf_word($file)
{
    ...
    $mimetype = finfo_file($finfos, $file);
    finfo_close($finfos);
