...
<body>
        ...
        <div class="input-container" style="display: flex;">
            ...
            <div class="input-field" style="margin-right: 10px; ">
                ...
                <select required name="id_per">
                    ...
                    $get_hos = "select * from student where s_id = $sid and status != 'GRADUATED' and a.name != 'ABUBACARR JOBARTEH'   order by name ";
                    $get = oci_parse(oci_connect($username, $password, $connection), $get_hos);
                    oci_execute($get);
                    while ($row = oci_fetch_array($get)) {
                    ?><option value="<?php echo $row["STUD_ID"]; ?> ">
  ...
  text-decoration: none;" name="edit_document" type="submit">
        ...
        <div style="display:flex; margin-top:20px;">
            <Label style="font-size: 18px; font-family: righteous;
         font-weight: bold; color: #1D5B79;">Add Student Mark</Label>
        </div>
        <div class="input-container" style="display: flex;">

            <?php $get_hos = "SELECT * FROM TERM_CALENDAR  ORDER BY TERM";
            //echo  $get_hos;
            ?>
            <div class="input-field" style="margin-right: 10px; ">
                <label for="subjectCode">Term</label>
                <select required name="add_stud_term">
                ...
                <select required name="add_stud_subject">
                ...
                <div>
                    ...
                    <input type="number" placeholder="Enter Continuous Assessment Mark" title="Only Numbers" name="add_cas" style="width:300px;" min=0.0 max=100 pattern="[0-9.]+" step="any">

                    <label>Examination(Mark To Converted To 70%)</label>
                    <input type="number" placeholder="Enter Exam Mark" title="Only Numbers" name="add_exam" style="width:200px;" min=0.0 max=100 pattern="[0-9.]+" step="any">
...
margin-top:10px;
margin-bottom:10px;
text-decoration: none;" name="add_mark" type="submit">
                    ADD MARK
                ...
                <div style="display:flex; margin-top:20px;">
                    <Label style="font-size: 18px; font-family: righteous;
         font-weight: bold; color: #1D5B79;">Edit Student Mark</Label>
                </div>
                <div class="input-container" style="display: flex;">
                    ...
                    <div class="input-field" style="margin-right: 10px; ">
                        <label for="subjectCode">Term</label>
                        <select required name="edit_stud_term">
                            <option disabled selected>Select Term</option>
                            <?php
                            $get = oci_parse(oci_connect($username, $password, $connection), $get_hos);
                            oci_execute($get);
                        ...
                        ?>
                        <label for="subjectCode">Subject</label>
                        <select required name="edit_stud_subject">
                            <option disabled selected>Select Subject</option>
                            <?php
                            $get_hos = "SELECT DISTINCT(A.SUB_CODE),B.SUBJECT FROM STUDENT_SUBJECT A JOIN WAEC_SUBJECT B ON (A.Sub_code=B.sub_code)  where a.stud_id = '$stuid' ORDER BY B.SUBJECT ";
                            $get = oci_parse(oci_connect($username, $password, $connection), $get_hos);
...
margin-top:10px;
margin-bottom:10px;
text-decoration: none;" name="edit_mark" type="submit">
                            EDIT MARK
                            <i class="uil uil-edit"></i>
                        </button>
                        <?php
                ...
                <div style="display:flex; margin-top:20px;">
                    <Label style="font-size: 18px; font-family: righteous;
         font-weight: bold; color: #1D5B79;">Remove Student Mark</Label>
                </div>
                <div class="input-container" style="display: flex;">
