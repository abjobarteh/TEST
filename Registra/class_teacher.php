...
<body>
    <form class="container" enctype="multipart/form-data" action="class_teacher.php" method="post">
        <div class="com">
    ...
    font-weight: bold; color: #1D5B79;">Assign Class Teacher To Class</Label>
  ...
  text-decoration: none;" name="assign" type="submit">
    ...
    font-weight: bold; color: #1D5B79; ">Unassign Class Teacher To Class</Label> </div>
        <div class="input-field" style="margin-right: 10px;">
            <label>Class</label>
