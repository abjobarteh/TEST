          ...
          //  echo $sql;
            ...
            ?><div style="font-size:15px;
               ...
               //   echo "SELECT A.STUD_ID,A.NAME,ROUND(B.GPA/1.00,2) AS GPA FROM STUDENT A JOIN  STUDENT_STANDINGS B ON (A.STUD_ID=B.STUD_ID) WHERE b.S_ID = $sid and b.class_code = $s_code and b.term = '$t' ";
                    $showgpa =  oci_parse($conn, "SELECT A.STUD_ID,A.NAME,ROUND(B.GPA/1.00,2) AS GPA FROM STUDENT A JOIN  STUDENT_STANDINGS B ON (A.STUD_ID=B.STUD_ID) WHERE b.S_ID = $sid and b.class_code = $s_code and b.term = '$t' ");
                    oci_execute($showgpa);
                            ?>
