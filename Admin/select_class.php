...
<body>
  ...
  <div class="wrapper">
    ...
    <h2>Teacher</h2>
    <form action="select_class.php" method="post" style="min-height: 250px;">
      <div class="input-box">
      ...
      <div class="input-box">
        <select required name="acad_year">
          ...
          <?php
          $get_hos = "select * from academic_calendar where s_id = $sid and start_dt is not null";
          $get = oci_parse(oci_connect($username, $password, $connection), $get_hos);
          oci_execute($get);
      ...
      <div class="message">
        ...
        ?><div style="font-size:15px;
                ...
                header("refresh:2;url=subject.php"); ?>
              </div> <?php
                    }
                  } else {
                      ?><div style="font-size:15px;
