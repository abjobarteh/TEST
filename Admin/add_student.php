...
<body>
    ...
    font-weight: bold; color: #04716f;">Add Student</Label>
        ...
        <div class="input-container" style="display: flex;">
            ...
            <div class="input-field" style="margin-right: 10px; ">
                ...
                <label for="subjectCode" style="font-weight: 900;">(Required) </label>
                <input type="number" placeholder="Enter Previous Aggregate/GPA" title="Only Numbers" pattern="[0-9.]+" name="stu_score" required style="width: 270px;">
            </div>
        ...
        <div style="display:flex; margin-top:20px;">
            <Label style="font-size: 18px; font-family: righteous;
         font-weight: bold; color: #04716f;">Student Documentation</Label>
        </div>
        ...
        <div class="input-container" style="display: flex;">
            ...
            <div class="input-field" style="margin-right: 10px; ">
                <label for="subjectCode">Upload Declaration Of Responsibility</label>
                <label for="subjectCode" style="font-weight: 900;">(Required) </label>
  ...
  text-decoration: none;" name="establish" type="submit">
        ...
        if (isset($_POST['establish'])) {
            ...
            $sql = oci_parse($conn, "SELECT * FROM SUB_CLASS A JOIN PROG_CLASS B ON (A.SUB_CODE=B.SUB_CODE) WHERE A.CLASS_NAME = '$stu_class'");
            oci_execute($sql);
            while ($r = oci_fetch_array($sql)) {
                $progid = $r['PROG_ID'];
            }
            $sql = oci_parse($conn, "SELECT * FROM SUB_CLASS A JOIN CLASS B ON (A.CLASS=B.CLASS) WHERE A.CLASS_NAME = '$stu_class' ");
            oci_execute($sql);
            while ($r = oci_fetch_array($sql)) {
                $class = $r['CLASS'];
            }
            ...
            //     $idcombo = $currentDate.'1'.$progid;
            if ($id >= 0 &&  $id <= 9) {
                $stuid = $currentDate . '1' . $progid . '000' . $id;
            } else if ($id >= 10 && $id <= 99) {
                $stuid = $currentDate . '1' . $progid . '00' . $id;
            } else if ($id >= 100 && $id <= 999) {
                $stuid = $currentDate . '1' . $progid . '0' . $id;
            } else if ($id >= 1000) {
                $stuid = $currentDate . '1' . $progid . $id;
            }
                                            ...
                                            if (oci_fetch_all($sql, $a) == 0) {
                                                ...
                                                if (oci_fetch_all($sql, $a) == 0) {
                                                    ...
                                                    if (oci_fetch_all($sql, $a) == 0) {
                                                        ...
                                                        $sql = oci_parse($conn, "INSERT INTO STUDENT_ACADEMIC (STUD_ID,S_ID,CLASS,PREV_SCHOOL,SCORE,SUB_CODE,ACADEMIC_YEAR) VALUES ('$stuid','$sid','$stuclass','$stu_prev','$stu_score','$subclass','$a_y')");
                                                        oci_execute($sql);
                                                        ...
                                                        if (oci_fetch_all($sql, $a) == 0) {
                                                           ...
                                                           /*     $sql = oci_parse($conn, "SELECT * FROM FEE_PARAMETER WHERE S_ID = $sid and FEE_TYPE = 'COMPULSORY' ");
                                                                oci_execute($sql);
                                                                while ($r = oci_fetch_array($sql)) {
                                                                    $fid = $r['FEE_ID'];
                                                                    $cost = $r['COST'];
                                                                    $bal = $r['COST'];
                                                                    $sql = oci_parse($conn, "INSERT INTO STUDENT_FINANCE (FEE_ID,STUD_ID,AMOUNT,ACADEMIC_YEAR,TERM,BALANCE) VALUES ('$fid','$stuid',$cost,'$a_y','$t',$bal)");
                                                                    oci_execute($sql);
                                                                } */
        ...
        ?><div style="font-size:15px;
                                                                ...
                                                                Swal.fire({
                                                                    position: "center",
                                                                    icon: "success",
                                                                    title: "' . $name . ' STUDENT ID: ' . $stuid . ' ADDED SUCESSFULLY ' . '",
                        ...
                        ?></div><?php
                            ...
                            echo '<script>
                                                                Swal.fire({
                                                                    position: "center",
                                                                    icon: "warning",
                                                                    title: "ACADEMIC YEAR AND TERM HAVE NOT SETUP",
                                                                    showConfirmButton: false,
                                                                    timer: 1500
                                                                  });
                                                                </script>';
