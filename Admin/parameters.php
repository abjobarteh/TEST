...
<body>
  ...
  text-decoration: none;" name="generate" type="submit">
    ...
    font-weight: bold; color: #04716f;">Add Fee Parameter</Label>
  ...
  text-decoration: none;" name="add" type="submit">
        ...
        ?>
        <Label style="font-size: 18px; font-family: sans-serif;
    font-weight: bold; color: #04716f;">Edit Fee Parameter</Label>
        <div class="input-container" style="display: flex;">
  ...
  text-decoration: none;" name="filter" type="submit">
        ...
        <div style="display:flex; margin-top:20px;">
         ...
         font-weight: bold; color: #04716f;">Assign Non Compulsory Fee To Student</Label>
        </div>
