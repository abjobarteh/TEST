...
<body>
    <form class="container" enctype="multipart/form-data" action="show_graduated_students.php" method="post">
        <div class="com">
            <h3>
        ...
        <div class="input-field">
            <select required name="reg">
                ...
                $get_hos = "select * from student a join student_academic b on (a.stud_id=b.stud_id) where a.s_id = $sid and b.sub_code = $sub_cd and a.status = 'GRADUATED' ORDER BY NAME";
  ...
  text-decoration: none;" name="filter" type="submit">
    ...
    margin: 5px;">
        ...
        if ($conn) {
            ...
            ob_start();
            $s = "select distinct(a.subject),c.sub_type from waec_subject a join student_subject b on (a.sub_code=b.sub_code) join subject c on (a.sub_code = c.sub_code)  where b.stud_id = '$stuid' order by c.sub_type,a.subject ";
    ...
    margin: 5px;">
        ...
        <div style="display:flex; margin-top:20px;">
            <Label style="font-size: 18px; font-family: righteous;
         font-weight: bold; color: #04716f;">Unassign Subject</Label>
        </div>
        <table class="table-content" style="  font-size: 14px;
    border-collapse: collapse;
    margin: 10px 0;
        ...
        if (isset($_POST['unassign_sub'])) {
            if (isset($_POST['un']) && !empty($_POST['un'])) {
                ...
                foreach ($selected_subcode as $subs_code) {
                    $check = oci_parse($conn, "select * from student_subject where sub_code = $subs_code ");
                    oci_execute($check);
  ...
  text-decoration: none;" name="generate" type="submit">
        ...
        <div class="buttons">
            ...
            <button class="backBtn" type="submit">
                ...
                <a class="btnText" href="select_grad_students.php">
                    BACK
                </a>
            </button>
        </div>
