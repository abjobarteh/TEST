...
<div style="max-height: 200px; overflow-y: auto;">
    ...
    font-weight: bold; color: #04716f;"></Label>
            ...
            <Label style="font-size: 18px; font-family: sans-serif;
    font-weight: bold; color: #04716f;">Set Letter Grade</Label>
        </div>
        <div class="input-container" style="display: flex;">
            <div class="input-field" style="margin-right: 10px;">
                <label>Grade</label>
  ...
  text-decoration: none;" name="establish" type="submit">
        ...
        ?><div style="font-size:15px;
                    ...
                    <?php echo "SELECT GRADE LETTER";
                        ...
                        ?>
        <Label style="font-size: 18px; font-family: sans-serif;
    font-weight: bold; color: #04716f;">Edit Letter Grade</Label>
        </div>
        <div class="input-container" style="display: flex;">
            <div class="input-field" style="margin-right: 10px;">
                <label>Range</label>
...
//echo "select * from grade a join gpa b on(a.g_code=b.g_code) where a.s_id = $sid order by b.g_code ";
        ...
        <Label style="font-size: 18px; font-family: sans-serif;
    font-weight: bold; color: #04716f;">Set Grade Point Average</Label>
        <div class="input-field" style="margin-right: 10px;">
            <label>Grade</label>
  ...
  text-decoration: none;" name="set_gpa" type="submit">
        ...
        ?><div style="font-size:15px;
                    ...
                    <?php echo "SELECT LETTER GRADE";
                        ...
                        ?>
        <Label style="font-size: 18px; font-family: sans-serif;
    font-weight: bold; color: #04716f;">Edit Grade Point Average</Label>
        <div class="input-field" style="margin-right: 10px;">
            <label>Grade</label>
        ...
        ?><div style="font-size:15px;
                ...
                animation:button .3s linear;text-align: center;">
                    <?php echo "SELECT LETTER GRADE";
                        ...
                        ?>
        <Label style="font-size: 18px; font-family: sans-serif;
    font-weight: bold; color: #04716f;">Set Subject Credit Hours</Label>
        <div class="input-field" style="margin-right: 10px;">
            <label>Subject</label>
        ...
        ?><div style="font-size:15px;
                ...
                animation:button .3s linear;text-align: center;">
                    <?php echo "SELECT SUBJECT 1";
                        ...
                        ?>
        <Label style="font-size: 18px; font-family: sans-serif;
    font-weight: bold; color: #04716f;">Edit Subject Credit Hours</Label>
        <div class="input-field" style="margin-right: 10px;">
            <label>Subject</label>
